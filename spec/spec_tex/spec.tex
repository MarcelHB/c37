...
void update_item(char *item);
	...
	\end{description}
		...
		\begin{lstlisting}[caption=print\_msg]{}
void print_msg(char *m);
	...
	\begin{description}
		\item[Verwendung:] Speichert einen String, der beim nächsten Aufruf von output\_draw() über der Statusleiste angezeigt wird (und dabei wahrscheinlich
			einen Teil des Spielfeldes überschreibt). Die Nachricht wird nur einen Aufruf von output\_draw() lang angezeigt und möglicherweise abgeschnitten,
